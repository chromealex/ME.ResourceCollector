...
namespace ME.ResourceCollector {
    ...
    public static class Utils {
        ...
        public static long GetTextureSize(UnityEngine.Texture texture) {
            ...
            if (getTextureSizeMethod == null) {

                var textureUtils = typeof(UnityEditor.Editor).Assembly.GetType("UnityEditor.TextureUtil");
                getTextureSizeMethod = textureUtils.GetMethod("GetStorageMemorySize", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static);

            }

            return (int)getTextureSizeMethod.Invoke(null, new[] { texture });
        ...
        public static long GetObjectSize(ResourceCollectorData data, object obj, System.Collections.Generic.HashSet<object> visited, System.Collections.Generic.List<UnityEngine.Object> deps, bool collectUnityObjects) {

            if (visited == null) visited = new System.Collections.Generic.HashSet<object>();

            var ptr = obj;
            if (visited.Contains(ptr) == true) return 0L;
            visited.Add(ptr);
            ...
            /*if (type == typeof(UnityEngine.ParticleSystem)) {
            ...
            if (typeof(UnityEngine.Renderer).IsAssignableFrom(type) == true) {
                ...
                if (typedObj == null) return pointerSize;
                ...
                if (typedObj.sharedMaterials != null) {
                    ...
                    foreach (var mat in typedObj.sharedMaterials) {
                        ...
                        size += GetObjectSize(data, mat, visited, deps, collectUnityObjects);

                    }

                } else {
                    
                    size += GetObjectSize(data, typedObj.sharedMaterial, visited, deps, collectUnityObjects);
            ...
            if (type == typeof(UnityEngine.Mesh)) {
                ...
                if (data.GetSize(mesh, out var s) == true) {
                    ...
                    size += data.UpdateSize(mesh, GetMeshSize(mesh));
                }
            ...
            if (type == typeof(UnityEngine.MeshFilter)) {
                ...
                if (mesh == null) return pointerSize;
            ...
            if (type == typeof(UnityEngine.SpriteRenderer)) {
                ...
                size += GetObjectSize(data, typedObj.sprite, visited, deps, collectUnityObjects);
            ...
            if (typeof(UnityEngine.Component).IsAssignableFrom(type) == true) {
                ...
                if (comp == null) return pointerSize;

                var go = ((UnityEngine.Component)obj).gameObject;
                if (go == null) return pointerSize;
                ...
                foreach (var item in tempResults) {
                    ...
                    size += GetObjectSize(data, item, visited, deps, collectUnityObjects);
            ...
            if (type == typeof(UnityEngine.GameObject)) {
                ...
                if (mat == null) return pointerSize;
                ...
                foreach (var prop in props) {
                    ...
                    size += GetObjectSize(data, tex, visited, deps, collectUnityObjects);
                ...
                if (sprite == null) return pointerSize;
                ...
                if (fields.Length == 0 && type.IsValueType == true) {
                    ...
                    foreach (var field in fields) {
                        ...
                        if (fieldType.IsEnum == true) {
                            ...
                            size += Utils.GetObjectSize(data, field.GetValue(obj), visited, deps, collectUnityObjects); //Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf(fieldType);
        ...
        static int CalcTotalIndices(UnityEngine.Mesh mesh)
        {
            var totalCount = 0;
        ...
        static int ConvertFormatToSize(UnityEngine.Rendering.VertexAttributeFormat format)
        {
            switch (format)
            {
